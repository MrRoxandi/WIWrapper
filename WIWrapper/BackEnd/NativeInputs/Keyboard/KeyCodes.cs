namespace WIWrapper.BackEnd.NativeInputs.Keyboard
{
    public enum KeyCodes : byte
    {
        ...
        Subtract = 0x6D,
        Decimal = 0x6E,
        Divide = 0x6F,     // Extended
        NumPadEnter = 0x0D, // Extended 
        ...
        LWin = 0x5B, // Extended
        RWin = 0x5C, // Extended
        Apps = 0x5D, // Extended (Context Menu key)
        ...
        PageUp = 0x21,   // Extended
        PageDown = 0x22, // Extended
        End = 0x23,      // Extended
        Home = 0x24,     // Extended

        PrintScreen = 0x2C, // Extended
